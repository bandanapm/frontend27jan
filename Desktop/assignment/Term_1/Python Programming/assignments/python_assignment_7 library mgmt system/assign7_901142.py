...
class ModelLibrary:
    ...
    def search_book_by_author(self, author_name):
        ...
        :return: A list of titles of books by the given author.
        """
        books_by_author = [
            book.book_title for book in self.book_list.values() if book.book_author == author_name]
...
def main():
    ...
    while True:
        ...
        if option == '1':
            ...
            '''If input is 3, search the book'''
            author = input("Enter the name of author: ")
            books = lib.search_book_by_author(author)
            if books:
                print(f"The available books by {author} are:")
                for book in books:
                    print(book)
        elif option == '4':
            '''If input is 4, quit and exit the program'''
            print("Thank you !")
            break
        else:
